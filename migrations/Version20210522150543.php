 ...
 */
final class Version20210522150543 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE like_post (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, article_id INTEGER NOT NULL, CONSTRAINT FK_83FFB0F37294869C FOREIGN KEY (article_id) REFERENCES article (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, like_post_id INTEGER DEFAULT NULL, email VARCHAR(180) NOT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        , password VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_8D93D6491804490F FOREIGN KEY (like_post_id) REFERENCES like_post (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__like_post AS SELECT id, article_id FROM like_post');
        $this->addSql('DROP TABLE like_post');
        $this->addSql('CREATE TABLE like_post (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, article_id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO like_post (id, article_id) SELECT id, article_id FROM __temp__like_post');
        $this->addSql('DROP TABLE __temp__like_post');
        $this->addSql('CREATE INDEX IDX_83FFB0F37294869C ON like_post (article_id)');
